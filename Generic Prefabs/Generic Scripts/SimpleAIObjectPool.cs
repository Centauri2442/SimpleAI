...
namespace SimpleAI
{
    public class SimpleAIObjectPool : UdonSharpBehaviour
{
    private bool DoNotTransferOwnership;
    ...
    public VRCPlayerApi[] AllPlayers = new VRCPlayerApi[81];
    ...
    public override void OnPlayerJoined(VRCPlayerApi player)
    {
        ...
        if (ShiftArray)
            for (int i = AllPlayers.Length - 1; i > InsertionIndex; i--)
            {
