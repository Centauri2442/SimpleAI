...
namespace SimpleAI
{
    public class DoggoFollowToggleMultiState : UdonSharpBehaviour
    {
        [Header("Follow Toggle!")]
        [Tooltip("Number of states that can be toggled between! Don't include special states such as fetch states in this counter!")]
